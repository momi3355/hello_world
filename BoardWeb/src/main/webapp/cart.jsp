      ...
      <div class="basketdiv" id="basket">
          ...
          <div class="subdiv">
            <div class="basketcmd">
              <a
                ...
                class="abutton"
                onclick="javascript:basket.delItem(event);"
                >삭제</a
              >
            </div>
          </div>
        ...
        <div class="row data" data-id="1" style="display: block">
          <div class="subdiv">
            ...
            <div class="img">
              <img src="images/브라질산토스.jpg" width="60" />
            </div>
        ...
        <div class="row data" data-id="2" style="display: block">
          <div class="subdiv">
            ...
            <div class="img">
              <img src="images/케냐 오크라톡신.jpg" width="60" />
            </div>
        ...
        <div class="row data" data-id="3" style="display: block">
          <div class="subdiv">
            ...
            <div class="img">
              <img src="images/코스타리카 따라주.jpg" width="60" />
            </div>
